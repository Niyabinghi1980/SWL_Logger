...
def save_swl_report():
    ...
    current_session_reports.append(
        [callsign_1, qth_locator_1, callsign_2, qth_locator_2, date, time, frequency, mode, readability,
         signal_strength, tone, details])
...
entry_qth_locator_2.grid(row=3, column=1, padx=5, pady=5)
...
entry_date.grid(row=4, column=1, padx=5, pady=5)
entry_date.insert(0, datetime.now().strftime("%d-%m-%Y"))
...
entry_time.grid(row=5, column=1, padx=5, pady=5)
entry_time.insert(0, datetime.now().strftime("%H:%M"))
...
entry_frequency.grid(row=6, column=1, padx=5, pady=5)
...
entry_signalstrength.grid(row=9, column=1, padx=5, pady=5)
...
entry_tone.grid(row=10, column=1, padx=5, pady=5)
...
entry_details.grid(row=11, column=1, padx=5, pady=5)
entry_details.bind("<Return>", next_field)  # Connect Enter

# Listbox for reports
report_list = tk.Listbox(root, height=10, width=70)
report_list.grid(row=12, column=0, columnspan=2, padx=10, pady=5)

# Save button
save_button = tk.Button(root, text="Save", command=save_swl_report)
save_button.grid(row=13, column=0, padx=5, pady=5, sticky="ew")

# Open button
open_button = tk.Button(root, text="Open logfile", command=open_excel_file)
open_button.grid(row=13, column=1, padx=5, pady=5, sticky="ew")

# About button
about_button = tk.Button(root, text="About", command=show_about)
about_button.grid(row=14, column=0, padx=5, pady=5, sticky="ew")

# Exit button
exit_button = tk.Button(root, text="Exit", command=root.quit)
exit_button.grid(row=14, column=1, padx=5, pady=5, sticky="ew")
