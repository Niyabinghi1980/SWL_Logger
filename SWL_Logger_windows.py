...
def open_excel_file():
    try:
        os.startfile("swl_reports.xlsx")  # Works on windows
...
save_button.grid(row=13, column=0, padx=5, pady=5)

# Excel button
open_button = tk.Button(root, text="Open logfile", command=open_excel_file)
open_button.grid(row=13, column=1, padx=5, pady=5)

# Exit button
exit_button = tk.Button(root, text="Exit", command=root.quit)
exit_button.grid(row=13, column=0, columnspan=2, pady=10)
